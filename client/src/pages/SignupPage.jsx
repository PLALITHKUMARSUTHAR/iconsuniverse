    ...
    <div className="max-w-md mx-auto py-4 sm:py-6 px-4">
      ...
      <div className="p-6 sm:p-7 rounded-3xl bg-white border border-slate-200/80 shadow-xl flex flex-col gap-4">
        <div className="text-center">
          ...
          <h1 className="text-xl font-black font-heading text-slate-900">Create Free Account</h1>
          <p className="text-[11px] text-slate-500 mt-0.5">
            Get instant access with 100 free downloads daily.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full bg-slate-50 pl-10 pr-4 py-2 rounded-xl text-xs font-medium border border-slate-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all text-slate-800"
              />
            </div>
          </div>
