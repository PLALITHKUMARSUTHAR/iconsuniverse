...
const SearchResultsPage = () => {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {isCategoryComplete && (
        <div className="my-8 p-6 sm:p-8 rounded-3xl bg-white border border-landing-surface-container text-center shadow-xs flex flex-col items-center justify-center gap-3 animate-fade-in">
      ...
      {isCategoryMode && (
        <div className="my-6 p-4 sm:p-5 rounded-3xl bg-white border border-landing-surface-container shadow-2xs flex flex-col gap-3">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold font-heading text-landing-primary">
            ...
            {featured11Categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 rounded-2xl bg-landing-surface-container-low hover:bg-landing-surface-container text-landing-on-surface text-xs font-bold shrink-0 transition-colors border border-landing-surface-container cursor-pointer"
                >
