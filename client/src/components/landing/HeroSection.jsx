...
const HeroSection = () => {
  return (
    <section className="relative z-30 w-full pt-10 pb-10 sm:pt-13 sm:pb-14">
      {/* Soft Background Decorative Glows - Isolated in overflow-hidden container */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
        <div className="absolute -top-24 -left-24 w-80 h-80 rounded-full bg-landing-vibrant-coral/10 blur-3xl" />
        <div className="absolute top-1/3 -right-24 w-80 h-80 rounded-full bg-landing-electric-teal/15 blur-3xl" />
      </div>

      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 text-center relative z-20">
        {/* Brand Top Badge */}
